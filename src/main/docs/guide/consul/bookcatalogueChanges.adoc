...
Previous configuration registers a Micronaut app with Consul with minimal configuration. Discover a more complete list of Configuration options at https://docs.micronaut.io/latest/api/io/micronaut/discovery/consul/ConsulConfiguration.html[ConsulConfiguration].
